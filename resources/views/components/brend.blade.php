    ...
    <div class="rts-service-details-area d-block">
    <div class="container">
        <div class="row mb--30 mt-5">
            <div class="col--12">
                <div class="title-area text-start">
                    <h2 class="title sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">@lang('index.our_clients_title')</h2>
                </div> 
            </div>
        </div>
        <div class="service-detials-step-2 ">
            <div class="row mb--40 mb_md--20 mb_sm--20">
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 sal-animate p-0 grayscale-box" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-service-step text-center" title="AKFA">
                        <img src="/assets/images/brand/Akfa_logo.png" alt="Brand_area_images">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 sal-animate p-0 grayscale-box" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-service-step text-center" title="NBU | Oʻzbekiston milliy banki">
                        <img src="assets/images/brand/NBU-01.png" alt="Brand_area_images">
                    </div>
                </div>
                ...
                <!-- <div class="col-lg-3 col-md-4 col-sm-6 col-6 sal-animate p-0 grayscale-box" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-service-step text-center" title="Barrier Gidrohimoya">
                        <img src="assets/images/brand/barrier.png" alt="Brand_area_images">
                    </div>
                </div>
                -->
               ...
               <!-- <div class="col-lg-3 col-md-4 col-sm-6 col-6 sal-animate p-0 grayscale-box" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-service-step text-center" title="Perfect">
                        <img src="assets/images/brand/perfect.png" alt="Brand_area_images">
                    </div>
                </div> 
                
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 sal-animate p-0 grayscale-box" data-sal-delay="350" data-sal="slide-up" data-sal-duration="800">
                    <div class="single-service-step text-center" title="DiCloud">
                        <img src="assets/images/brand/dicloud.png" alt="Brand_area_images">
                    </div>
                </div> 
                -->
            </div>
