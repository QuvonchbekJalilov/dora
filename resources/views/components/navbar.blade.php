<div class="mobile-search">
      <form action="/" class="search-form">
         <img src="/backend/img/svg/search.svg" alt="search" class="svg">
         ...
         <div class="navbar-left">
            <div class="logo-area">
               <a class="navbar-brand" href="index.html">
                  <img class="dark" src="/backend/img/logo-dark.png" alt="logo">
                           ...
                           <li>
                              <ul>
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="/backend/img/svg/mail.svg" alt="mail" class="svg nav-icon">
                                 ...
                                 <li>
                                    <a href="chat.html" class="">
                                       <img src="/backend/img/svg/message-square.svg" alt="message-square" class="svg nav-icon">
                                 ...
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="/backend/img/svg/shopping-cart.svg" alt="shopping-cart" class="svg nav-icon">
                                 ...
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="/backend/img/svg/user-check.svg" alt="user-check" class="svg nav-icon">
                                 ...
                                 <li>
                                    <a href="chat.html" class="">
                                       <img src="/backend/img/svg/bookmark.svg" alt="bookmark" class="svg nav-icon">
                                       <span class="menu-text">Note</span>
                                    </a>
                                 </li>
                                 <li>
                                    <a href="chat.html" class="">
                                       <img src="/backend/img/svg/activity.svg" alt="activity" class="svg nav-icon">
                              ...
                              <ul>
                                 <li>
                                    <a href="kanban.html" class="">
                                       <img src="/backend/img/svg/columns.svg" alt="columns" class="svg nav-icon">
                                       <span class="menu-text">Kanban Board</span>
                                    </a>
                                 </li>
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="/backend/img/svg/repeat.svg" alt="repeat" class="svg nav-icon">
                                 ...
                                 <li>
                                    <a href="file-manager.html" class="">
                                       <img src="/backend/img/svg/file.svg" alt="file" class="svg nav-icon">
                                       <span class="menu-text">File Manager</span>
                                    </a>
                                 </li>
                                 <li>
                                    <a href="task-app.html" class="">
                                       <img src="/backend/img/svg/clipboard.svg" alt="clipboard" class="svg nav-icon">
                                 ...
                                 <li class="has-subMenu-left">
                                    <a href="#" class="">
                                       <img src="/backend/img/svg/user.svg" alt="user" class="svg nav-icon">
                        ...
                        <ul class="subMenu">
                           <li>
                              <a href="editors.html" class="">
                                 <img src="/backend/img/svg/edit.svg" alt="svg" class="svg nav-icon">
                                 <span class="menu-text">Editors</span>
                              </a>
                           </li>
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/grid.svg" alt="grid" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/bar-chart-2.svg" alt="bar-chart-2" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/disc.svg" alt="disc" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/map.svg" alt="map" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/server.svg" alt="server" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/square.svg" alt="square" class="svg nav-icon">
                           ...
                           <li class="has-subMenu-left">
                              <a href="#" class="">
                                 <img src="/backend/img/svg/book.svg" alt="book" class="svg nav-icon">
         ...
         <div class="navbar-right">
            <ul class="navbar-right__menu">
               ...
               <li class="nav-message">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle icon-active">
                        <img class="svg" src="/backend/img/svg/message.svg" alt="img">
                     </a>
                           ...
                           <ul>
                              <li class="author-online has-new-message">
                                 <div class="user-avater">
                                    <img src="/backend/img/team-1.png" alt="">
                                 </div>
               ...
               <li class="nav-notification">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle icon-active">
                        <img class="svg" src="/backend/img/svg/alarm.svg" alt="img">
                     </a>
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper">
                           ...
                           <ul>
                              <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--primary">
                                    <img class="svg" src="/backend/img/svg/inbox.svg" alt="inbox">
                                 </div>
                              ...
                              <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--secondary">
                                    <img class="svg" src="/backend/img/svg/upload.svg" alt="upload">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                              ...
                              <li class="nav-notification__single nav-notification__single--unread d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--success">
                                    <img class="svg" src="/backend/img/svg/log-in.svg" alt="log-in">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                              ...
                              <li class="nav-notification__single nav-notification__single d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--info">
                                    <img class="svg" src="/backend/img/svg/at-sign.svg" alt="at-sign">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
                              ...
                              <li class="nav-notification__single nav-notification__single d-flex flex-wrap">
                                 <div class="nav-notification__type nav-notification__type--danger">
                                    <img src="/backend/img/svg/heart.svg" alt="heart" class="svg">
                                 </div>
                                 <div class="nav-notification__details">
                                    <p>
                                       <a href="" class="subject stretched-link text-truncate" style="max-width: 180px;">James</a>
               ...
               <li class="nav-settings">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle">
                        <img src="/backend/img/setting.png" alt="setting">
                     </a>
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper dropdown-wrapper--large">
                           <ul class="list-settings">
                              <li class="d-flex">
                                 <div class="me-3"><img src="/backend/img/mail.png" alt=""></div>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="/backend/img/color-palette.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="/backend/img/home.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="/backend/img/video-camera.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="/backend/img/document.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
                              ...
                              <li class="d-flex">
                                 <div class="me-3"><img src="/backend/img/microphone.png" alt=""></div>
                                 <div class="flex-grow-1">
                                    <h6>
               ...
               <li class="nav-flag-select">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle"><img src="/backend/img/flag.png" alt="" class="rounded-circle"></a>
                     <div class="dropdown-parent-wrapper">
                        <div class="dropdown-wrapper dropdown-wrapper--small">
                           <a href=""><img src="/backend/img/eng.png" alt=""> English</a>
                           <a href=""><img src="/backend/img/ger.png" alt=""> German</a>
                           <a href=""><img src="/backend/img/spa.png" alt=""> Spanish</a>
                           <a href=""><img src="/backend/img/tur.png" alt=""> Turkish</a>
                           <a href=""><img src="/backend/img/iraq.png" alt=""> Arabic</a>
                        </div>
                     </div>
               ...
               <li class="nav-author">
                  <div class="dropdown-custom">
                     <a href="javascript:;" class="nav-item-toggle"><img src="/backend/img/author-nav.jpg" alt="" class="rounded-circle">
                        ...
                        <div class="dropdown-wrapper">
                           <div class="nav-author__info">
                              <div class="author-img">
                                 <img src="/backend/img/author-nav.jpg" alt="" class="rounded-circle">
                              </div>
                              <div>
            ...
            <div class="navbar-right__mobileAction d-md-none">
               <a href="#" class="btn-search">
                  <img src="/backend/img/svg/search.svg" alt="search" class="svg feather-search">
                  <img src="/backend/img/svg/x.svg" alt="x" class="svg feather-x"></a>
               <a href="#" class="btn-author-action">
                  <img class="svg" src="/backend/img/svg/more-vertical.svg" alt="more-vertical"></a>
            </div>
         </div>
         <!-- ends: .navbar-right -->
      </nav>
         ...
         <div class="sidebar sidebar-collapse" id="sidebar">
            <div class="sidebar__menu-group">
               <ul class="sidebar_nav">
                  ...
                  <li>
                     <a href="{{ route('newService.index')}}" class="">
