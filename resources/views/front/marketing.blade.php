...
@section('title')
Маркетинговые услуги | DORA®
@endsection

@section('desc')
Маркетинговые услуги в Ташкенте - все цены, отзывы! Маркетинговые услуги в Ташкенте: лучшие предложения от ведущих компании.
@endsection
            ...
            <div class="tab-button-area-one">
               <ul class="nav nav-tabs" id="myTab" role="tablist">
                  <li class="nav-item" role="presentation">
                     <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="contact" aria-selected="false">  @lang('index.all') </button>
                  </li>
                  <li class="nav-item " role="presentation">
                  ...
                  <li class="nav-item" role="presentation">
                   ...
                   <li class="nav-item" role="presentation">
                     <button class="nav-link active" id="marketing-tabs" data-bs-toggle="tab" data-bs-target="#marketing" type="button" role="tab" aria-controls="marketing" aria-selected="false"> @lang('index.marketing') </button>
                  </li>
               </ul>
            </div>
            <div class="tab-content-area mt--50 mt_sm--30">
               <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade active  show" id="marketing" role="tabpanel" aria-labelledby="marketing-tab">
                     <!-- tab product area -->
                     <div class="row g-5">
...
<script type="application/ld+json">
    {
      ...
      "mainEntity": [{
        "@type": "Question",
        "name": "Где находится DORA?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "DORA находится по адресу: Узбекистан, Ташкент, Чиланзарский р-н, ул. Чиланзар, 2/2."
        }
      }, {
        "@type": "Question",
        "name": "Номера телефонов DORA?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Позвонить в DORA вы можете по номерам . +998 93 512 5324"
        }
      }]
    }
    </script>
