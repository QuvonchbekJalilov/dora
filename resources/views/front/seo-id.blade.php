...
@section('title'){{$seo_services['title_'. \App::getLocale()] }} в Ташкенте Цена от {{$seo_services['price'] }}$ - DORA @endsection

@section('desc')Разработка {{$seo_services['title_'. \App::getLocale()] }} в Ташкенте Цена от {{$seo_services['price'] }}$, @lang('desc.services')@endsection
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 breadcrumb-1">
                    <h1 class="title text-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">{{$seo_services['title_'. \App::getLocale()] }}</h1>
                </div>
                       ...
                       <!-- single downlaod area start -->
                        <div class="single-download-area">
                            ...
                            <a class="title text-dark fw-bolder">
                               @lang('index.from') <span id="price_sum" name="price_sum">{{$seo_services['price'] }}$</span> @lang('index.from_uz')
                            </a>
                        </div>
                        <!-- single downlaod area End -->
                        <!-- single downlaod area start -->
                        <div class="single-download-area">
                            ...
                            <a class="title text-dark fw-bolder">
                                {{$seo_services['date_'. \App::getLocale()] }}
                            </a>
                        </div>
                        <!-- single downlaod area End -->
                    </div>
