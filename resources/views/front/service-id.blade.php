...
@section('title'){{$product->getTranslatedAttribute('title', app()->getLocale()) }} в Ташкенте Цена от {{$product->getTranslatedAttribute('price', app()->getLocale()) }}$ - DORA @endsection

@section('desc')Разработка {{$product->getTranslatedAttribute('title', app()->getLocale()) }} в Ташкенте Цена от {{$product->getTranslatedAttribute('price', app()->getLocale()) }}$, @lang('desc.services')
@endsection

@section('keywords')Разработка логотипа, Продвижение в справочниках, HTML5 баннеры, amoCRM, сколько стоит разработка логотипа, разработка логотипа цена, разработка логотипа цена фриланс, Разработка сайтов, СММ продвижение, Создание сайтов, Продвижение соц сетях, Разработка интернет магазинов в ташкенте, разработка логотипов в ташкенте, разработка телеграм ботов, создание телеграм ботов, брендинг в ташкенте, сео продвижение, seo продвижение сайтов в ташкенте, контекстная реклама, срм системы в ташкенте, программа для автоматизации, битрикс24, разработчики сайтов, рекламные ролики, видеосъемка в ташкенте, рекламные компании, веб студия, онлайн реклама, нейминг в ташкенте, разработка мобильных приложении, amocrm, амосрм, мой склад, складской учет, программа для торговли@endsection

    <div class="rts-breadcrumb-area breadcrumb-bg bg_image">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 breadcrumb-1">
                    <h1 class="title text-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">{{$product->getTranslatedAttribute('title', app()->getLocale()) }}</h1>
                </div>
                ...
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="">
                        <div class="thumbnail mb--30" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                            <img src="/storage/{{$product->image ?? 'noimage'}}" alt="business-area">
                        </div>
                    ...
                    <div class="rts-single-wized Categories service" data-sal-delay="150" data-sal="slide-left" data-sal-duration="800">
                        ...
                        <div class="wized-body">
                            ...
                            <ul class="single-categories">
                                <li><a href="{{ route('seoservicesID', $item->id) }}">{{ $item['title_' . \App::getLocale()] }} <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
                            </ul>
                       ...
                       <!-- single downlaod area start -->
                        <div class="single-download-area">
                            ...
                            <a class="title text-dark fw-bolder">
                               @lang('index.from') <span id="price_sum" name="price_sum">{{$product['price'] }}$</span> @lang('index.from_uz')
                            </a>
                        </div>
                        <!-- single downlaod area End -->
                        <!-- single downlaod area start -->
...
fetch(uri)
  ...
  .then(data => {
    ...
    price_usd = {{$product->getTranslatedAttribute('price', app()->getLocale()) }}
