        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 breadcrumb-1">
                    <h1 class="title text-center" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">{{$site_services['title_'. \App::getLocale()] }}</h1>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="rts-single-wized Categories service" data-sal-delay="150" data-sal="slide-left" data-sal-duration="800">
                        ...
                        <div class="wized-body">
                            ...
                            <ul class="single-categories">
                                <li><a href="{{ route('siteservicesID', $item->id) }}">{{ $item['title_' . \App::getLocale()] }} <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
                            </ul>
                    ...
                    <div class="rts-single-wized download service" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        ...
                        <div class="wized-body">
                            ...
                            <div class="single-download-area">
                                ...
                                <a class=" rts-btn btn-primary" href="/assets/about_dora_ru.pdf" target="_blank"><i class="fal fa-arrow-right"></i></a>
                            </div>
                            <!-- single downlaod area End -->
                            <!-- single downlaod area start -->
                             <div class="single-download-area" id="brif">
                                <img src="/assets/images/service/icon/08.svg" alt="Business_downlaod">
                                <div class="mid">
                                    <h6 class="title" title="@lang('index.brif_title')">
                                        @lang('index.brif')
                                    </h6>
                                    <span>@lang('index.buttons.download')</span>
                                </div>
                                <a class="rts-btn btn-primary" href="/assets/brif_na_razrabotku_sayta.doc" download><i class="fa-solid fa-download"></i></a>
                            </div>
                            <!-- single downlaod area End -->
                        </div>
                    </div>
                       ...
                       <!-- single downlaod area start -->
                        <div class="single-download-area">
                            ...
                            <a class="title text-dark fw-bolder">
                               @lang('index.from') <span type="text" id="price_sum" name="price_sum">{{$site_services['price'] }}$</span>@lang('index.from_uz')
                            </a>
                                                    </div>
                        <!-- single downlaod area End -->
                        <!-- single downlaod area start -->
                        <div class="single-download-area">
                            ...
                            <a class="title text-dark fw-bolder">
                                {{$site_services['date_'. \App::getLocale()] }}
                            </a>
                        </div>
                        <!-- single downlaod area End -->
                    </div>
...
function displayElement() {
    ...
    if(currentPath == "/site-services/3" || currentPath == "/site-services/4" || currentPath == "/site-services/5" || currentPath == "/site-services/6" || currentPath == "/site-services/7" || currentPath == "/site-services/8")
        {
           document.getElementById('brif').style.display = "block"; 
    }else {
        document.getElementById('brif').style.display = "none";
    }
