    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                <div class="bread-tag">
                    <a href="{{ route('index') }}" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800"
                        class="text-primary">@lang('index.portfolio_detals_menu')</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact"
                                ...
                                @lang('index.all') </button>
                        </li>
                        <li class="nav-item " role="presentation">
                            <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                                type="button" role="tab" aria-controls="home"
                                aria-selected="true">@lang('index.social_media_add')</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile"
                                type="button" role="tab" aria-controls="profile" aria-selected="false">
                                @lang('index.advertising') </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link " id="site-tab" data-bs-toggle="tab" data-bs-target="#site"
                                type="button" role="tab" aria-controls="site" aria-selected="false">
                                @lang('index.website_development') </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="marketing-tabs" data-bs-toggle="tab"
                                data-bs-target="#marketing" type="button" role="tab" aria-controls="marketing"
                                aria-selected="false"> @lang('index.marketing') </button>
                        </li>
                    </ul>
                </div>
                                        ...
                                        <div class="rts-product-one">
                                            <div class="product-contact-wrapper">
                                                <a href="{{ route('designservicesID', $designservice->id) }}">
                                                    <h5 class="title">
                                                        {{ $designservice['title_' . \App::getLocale()] }}</h5>
                                                </a>
                           ...
                           <div class="row g-5">
                               @foreach ($siteservices as $item)
                                   <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       ...
                                       <div class="rts-product-one">
                                           <div class="product-contact-wrapper">
                                               <a href="{{ route('designservicesID', $item->id) }}">
                                                   <h5 class="title">
                                                       {{ $item['title_' . \App::getLocale()] }}</h5>
                                               </a>
                                        ...
                                        <div class="rts-product-one">
                                            <div class="product-contact-wrapper">
                                                <a href="{{ route('seoservicesID', $seoservice->id) }}">
                                                    <h5 class="title">{{ $seoservice['title_' . \App::getLocale()] }}
                                                    </h5>
                                                </a>
                                                <span class="text-primary">@lang('index.advertising')</span>
                                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                        ...
                                        <div class="rts-product-one">
                                            <div class="product-contact-wrapper">
                                                <a href="{{ route('seoservicesID', $seoservice->id) }}">
                                                    <h5 class="title">
                                                        {{ $seoservice['title_' . \App::getLocale()] }}</h5>
                                                </a>
                                                <span class="text-primary">@lang('index.social_media_add')</span>
                                            </div>
                                        </div>
