    ...
    <div class="container">
        <div class="row">
            <div class="title-area text-start">
                <h2 class="title sal-animate" data-sal-delay="250" data-sal="slide-up" data-sal-duration="800">@lang('index.official_partner')</h2>
            </div>
            <div class="col-12">
                    ...
                    <ul class="nav d-flex justify-content-start" id="myTab" role="tablist">
                        ...
                        <li class="nav-item col-lg-2 justify-content-center" role="presentation">
                            <button class="nav-link dr-filter-pertners" id="contact-marketing" data-bs-toggle="tab"
                                    ...
                                    aria-selected="false">
                                <img src="assets/images/brand/marketing.webp" alt="МАРКЕТИНГОВАЯ АССОЦИАЦИЯ УЗБЕКИСТАНА">
                            </button>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content-area mt--50 mt_sm--30">
                    <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="rts-product-one">
                                        <div class="product-contact-wrapper">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12 col-lg-6">
                                                    <img src="assets/images/brand/amosertificat.webp" width="100%" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="rts-product-one">
                                        <div class="product-contact-wrapper row">
                                            ...
                                            <p class="">
                                                Dora – ваш надежный партнер в области автоматизации бизнес-процессов на протяжении более пяти лет. 
                                                Наша компания специализируется на создании инновационных решений, направленных на оптимизацию и улучшение эффективности вашего бизнеса. 
                                                Мы предоставляем широкий спектр услуг, охватывающих различные отрасли и сферы деятельности. 
                                                Наш опыт в области автоматизации включает в себя разработку программных продуктов, адаптированных под индивидуальные потребности клиента, а также внедрение передовых технологий для повышения производительности и сокращения временных затрат. 
                                                Мы гордимся своей командой профессионалов, способных создавать интегрированные и интуитивно понятные решения, удовлетворяющие самым высоким стандартам качества. 
                                                Наш подход к автоматизации бизнес-процессов не только повышает эффективность вашей компании, но также обеспечивает надежность и безопасность ваших данных. 
                                                Выбирая Dora, вы делаете ставку на инновации, надежность и успешное развитие вашего бизнеса. 
                                                Мы готовы сотрудничать с вами для достижения ваших стратегических целей и обеспечения долгосрочного успеха.
                                            </p>
                                            <a href="#" class="rts-btn btn-primary d-none" target="_blank">
                                                @lang('index.buttons.more-details')
                                               <i class="fa-solid fa-angle-right"></i>
                                    ...
                                    <div class="rts-product-one">
                                        <div class="product-contact-wrapper row">
                                            <div class="col-sm-12 col-lg-6">
                                                ...
                                                <p class="">
                                                   Системный интегратор «Команда F5» входит в ТОП-1 интеграторов amoCRM. За 10 лет работы реализовано более 2000 проектов.
                                                   Компания предоставляет консалтинговые и сервисные услуги, а также разрабатывает SaaS-решения и различные интеграции.
                                                </p>
                                                <a href="#" class="rts-btn btn-primary d-none" target="_blank">
                                                    @lang('index.buttons.more-details')
                                                   <i class="fa-solid fa-angle-right"></i>
                        ...
                        <div class="tab-pane fade" id="marketing" role="tabpanel" aria-labelledby="contact-marketing">
                            <!-- tab product area -->
                            <div class="row g-5">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    <!-- single -product area -->
                                    <div class="rts-product-one">
                                        <div class="product-contact-wrapper row">
                                            <div class="col-sm-12 col-lg-6">
                                                <a href="https://marketing.uz/assotsiirovannye-partnery/dora.htm" target="_blank">
                                                    <h3 class="title">Ассоциированные партнеры MARKETING.UZ</h3>
                                                </a>
                                                <p class="">
                                                   Добро пожаловать в самое крупное бизнес-сообщество маркетологов Центральной Азии! 
                                                   Мы объединяем тех, кто развивает бизнес в Узбекистане с помощью маркетинга и его инструментов.
                                                </p>
                                                <a href="https://marketing.uz/assotsiirovannye-partnery/dora.htm" class="rts-btn btn-primary" target="_blank">
                                                    @lang('index.buttons.more-details')
                                                   <i class="fa-solid fa-angle-right"></i>
                                                </a>
                                            </div>
